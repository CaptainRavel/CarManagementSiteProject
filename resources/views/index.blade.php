 ...
 <!-- panel with foto -->
    <div class= "row my-5 align-items-center ">
        ...
        <div class="col-12 col-md-6">
                    ...
                    <p class="text-light">Dzięki naszej witrynie sprawnie znajdziesz wszystkie niezbędne informacje na temat swojego auta. Obliczysz średnie spalanie. Sprawdzisz ile wydałeś na naprawy swojego auta oraz tankowania.</p>
        </div>
    </div>
</div>
                    ...
                    <div class="col-md-4 mb-4">
                          <div class="card shadow-sm border border-warning">
                             <img src="{{ URL::to('/img/car-traffic.jpg') }}" />
                               <div class="card-body">
                                  <h3>Auto Dane</h3>
                                <p class="text-justify">Znajdziesz tutaj wszystkie niezbędne dane techniczne wybranego przez Ciebie auta.</p>
                               </div>
                    ...
                    <div class="col-md-4 mb-4">
                         <div class="card shadow-sm border border-warning">
                            <img src="{{ URL::to('/img/tankowanie.jpg') }}" />
                                ...
                                <p class="text-justify">Oblicz swoje średnie spalanie. Wystarczy, że podasz przejechany dystans i liczbę zatankowanych litrów.</p>
                                </div>
                                <div class="card-footer">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card shadow-sm border border-warning">
                            <img src="{{ URL::to('/img/car-tax.jpg') }}" />
                                <div class="card-body">
                                  <h3>Moje raporty</h3>
                                <p class="text-justify">Raportuj swoje tankowania oraz naprawy. Przejrzyj raporty, dowiedz się ile kosztuje Cię twój samochód.</p>
                                </div>
                                <div class="card-footer">
                                         @auth
                                        <a href="{{ route('user_raports.reports') }}" class="btn btn-warning d-flex justify-content-center font-weight-bold"> Raporty</a>
                                        @endauth
                                         @guest
