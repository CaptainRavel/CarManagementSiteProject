...
Route::get('/', [App\Http\Controllers\IndexPageController::class, 'index'])->name('home_site');;
...
Route::get('privacy_policy', [App\Http\Controllers\IndexPageController::class, 'privacypolicy'])->name('privacy_policy');
Route::get('terms_of_service', [App\Http\Controllers\IndexPageController::class, 'termsofservice'])->name('terms_of_service');
